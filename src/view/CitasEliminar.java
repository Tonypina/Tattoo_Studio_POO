...
public class CitasEliminar extends javax.swing.JPanel {
  ...
  private void llenarTablaCitas( ArrayList<Cita> lista ){
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(11, 122, 687, 302);
        ...
        add(jButton1);
        jButton1.setBounds(947, 391, 57, 33);
        ...
        add(jComboBox1);
        jComboBox1.setBounds(834, 261, 51, 24);
        ...
        add(jButton2);
        jButton2.setBounds(834, 391, 57, 33);
        ...
        add(jComboBox2);
        jComboBox2.setBounds(891, 261, 60, 24);
        ...
        add(jComboBox3);
        jComboBox3.setBounds(981, 261, 57, 24);
        ...
        add(jPanel1);
        jPanel1.setBounds(891, 122, 189, 44);
        add(jTextField4);
        jTextField4.setBounds(802, 122, 124, 22);

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondoI.jpg"))); // NOI18N
        jLabel10.setText("jLabel10");
        add(jLabel10);
        jLabel10.setBounds(-10, -10, 1160, 520);
