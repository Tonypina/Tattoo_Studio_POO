...
public class ProveedorDB {
    ...
    protected static void insertar( Proveedor p ){
        try{
    ...
    protected static Proveedor buscar( int idProveedor ){
        try{
            Connection cn =DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");
    ...
    protected static void modificar(Proveedor p){
        try{
            Connection cn =DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");
    ...
    protected static ArrayList<Proveedor> get(){
        try{
            Connection cn =DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");
