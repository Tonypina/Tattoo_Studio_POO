...
public class TatuadorDB {
    ...
    protected static ArrayList<Tatuador> get(){
        try{
    ...
    protected static void insertar( Tatuador t ){
        try{
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");            
    ...
    protected static Tatuador buscar( int id ){
        try{
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");
    ...
    protected static ArrayList<Tatuador> buscar( String nombre ){
        try{
            Connection cn =DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");
    ...
    protected static void modificar( Tatuador t ){
        try{
            Connection cn =DriverManager.getConnection("jdbc:mysql://localhost/tattoo_studio_db", "root", "");
